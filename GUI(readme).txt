...
## Overview
This is a simple Python GUI application built using Tkinter that allows users to track and manage student names. The application consists of two windows: a login window and a student name window.
