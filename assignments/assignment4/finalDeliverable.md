...
3. **Challenges and Overcoming Them:**
   ...
   Miled - Throughout the semester I was thrown with many challenges, like the languages aspect. Even though we used the extensive library of Python, I had to learn the strucutre of Tkinter, of how the classes and def correlate to each other. With Dash that was even more confusing because it was a mix of python and a bit HTML mixed into one. I definitely learned that if there is will power to make an aspect of your task/project work then anyone can conquer any lanauge. 
